...
├── src/
│   ├── main/
│   │   ├── java/com/example/personalitytest/
│   │   │   ├── activities/ (Login, MainMenu, Questionnaire, Profile, Admin)
│   │   │   ├── adapters/ (QuestionPager, NormTable, Profile)
│   │   │   ├── fragments/ (Question, CompetenceResult)
│   │   │   ├── models/ (User, Profile, NormTableItem)
│   │   │   ├── utils/ (ApiClient, DatabaseHelper, PreferencesHelper)
│   │   ├── res/
│   │   │   ├── layout/ (alle .xml-Dateien)
