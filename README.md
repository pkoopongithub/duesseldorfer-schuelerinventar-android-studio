...
├── src/<br>
│   ├── main/<br>
│   │   ├── java/com/example/personalitytest/<br>
│   │   │   ├── activities/ (Login, MainMenu, Questionnaire, Profile, Admin)<br>
│   │   │   ├── adapters/ (QuestionPager, NormTable, Profile)<br>
│   │   │   ├── fragments/ (Question, CompetenceResult)<br>
│   │   │   ├── models/ (User, Profile, NormTableItem)<br>
│   │   │   ├── utils/ (ApiClient, DatabaseHelper, PreferencesHelper)<br>
│   │   ├── res/<br>
│   │   │   ├── layout/ (alle .xml-Dateien)<br>
│   │   │   ├── values/ (strings.xml, colors.xml)<br>
